...
describe('AddDrugComponent', () => {
  ...
  let mockAddDrugService;
  let mockDataService

  beforeEach(async(() => {

    mockAddDrugService = sinon.createStubInstance(AddDrugService);
    mockAddDrugService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AddDrugService, useValue: mockAddDrugService },
