...
function licenseIssuer(newlicense) {
    ...
    issuedlicense.products_allowed=[];
  	issuedlicense.products_allowed=newlicense.products_allowed;
    /*for(var i = 0;i<newlicense.products_allowed.length;i++)
    {
        issuedlicense.products_allowed.push(newlicense.products_allowed);
    }*/
    trader.license=issuedlicense;
...
function addDrug(newproduct) {
    ...
    if(!trader.license.products_allowed.includes(newproduct.drug_id))
    {
